...
import { kids } from "../component/body.js"
...
show("baby_wear","freshness","").then((data)=>{
...
let x=document.getElementById("kids_accessories").children
for(let el of x){
...
for(let el of color){
    el.addEventListener("click",function(){
        cSearch("baby_wear","oldest",el.id)
    })
}
